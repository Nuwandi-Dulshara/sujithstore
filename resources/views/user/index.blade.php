...
<body>
    <div class="container-fluid">
        ...
        <div class="fixed-top bg-light">
            <div class="fixed-top bg-light">
                <div class="container">
                    <div class="d-flex mt-2 justify-content-end align-items-center gap-3">
                        @guest
                        <a href="{{ route('login') }}" class="btn btn-customelogin text-white text-decoration-none">
                            Login
                        </a>
                        @endguest @auth
                ...
                <nav class="navbar navbar-expand-lg bg-body-tertiary shadow">
                    <div class="container">
                        ...
                        <form method="GET" action="{{ route('search') }}" class="d-flex w-50 search-form mx-5"
                            role="search">
                            <div class="input-group w-100">
                                <!-- Category button with icon -->
                                <button class="btn btn-custome category-btn" type="button">
                                ...
                                <input type="text" name="q" value="{{ request('q') }}"
                                    ...
                                    placeholder="Search product or category here..." aria-label="Search" />
                            </div>
                        </form>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="#home">Home KS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mx-2" href="#about">About KS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mx-2" href="#promo">Promo</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="home section mt-5" id="home">
            ...
            <div class="container mt-5" style="padding-top: 130px">
                <div class="mt-4">
                    <img src="asset/img/cover.jpeg" alt="cover" class="cover-img" />
                </div>
            </div>
            <!-- Categories Carousel  -->
            <div class="container">
                                ...
                                <a href="{{ route('category.show', $category->slug) }}"
                                    ...
                                    <div class="circle-item">
                                        ...
                                        <img src="{{ asset('storage/' . $category->image) }}"
                                            alt="{{ $category->name }}">
                                        @else
                                        <img src="{{ asset('asset/img/default-category.png') }}" alt="Category">
                                        @endif
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card product-card h-100 shadow">
                                ...
                                <div class="position-relative">
                                    ...
                                    @else
                                    <img src="{{ asset('asset/img/placeholder.png') }}"
                                        class="card-img-top product-image"
                                        alt="No Image">
                ...
                <div class="about_section" id="about">
                    <div class="row align-items-center mt-5" style="
                        ...
                        <div class="col-lg-6 col-md-6 text-center">
                            <div class="m-5 p-5">
                                <img src="asset/img/cover.jpeg" class="img-fluid about-img"
        ...
        <div class="bg-black mt-5" id="promo">
            <div class="row">
                <div class="col-md-4 mt-5 align-items-center justify-content-center">
                    <div class="m-5 p-5">
                        <img src="asset/img/images-2.jfif" alt="Left Circle" class="circle-img" />
                    </div>
                </div>
                <div class="col-md-4 mt-5 align-items-center justify-content-center">
                    <div class="m-5 p-5 text-center justify-content-center align-items-center">
                ...
                <div class="col-md-4 mt-5 align-items-center justify-content-center">
                    <div class="m-5 p-5">
                        <img src="asset/img/842486e9.jpg" alt="Right Circle" class="circle-img" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mt-2 m-4 p-4">
                        <img src="asset/img/Agent2.jpg" alt="Sample Image" class="left-img img-fluid rounded-4" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mt-2 m-4 p-4">
                        <form class="custom-form">
                            <div class="form-group">
                                <label for="username" class="fs-5 fw-bold">User Name:</label>
                            ...
                            <div class="form-group">
                                <label for="message" class="fs-5 fw-bold">Message:</label>
                                <textarea id="message" rows="5"></textarea>
                            </div>

                            <button type="submit" class="btn btn-custome w-100">
                                Submit
                            </button>
                        </form>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="me-2">
                            <img src="asset/img/KS logo-2.png" alt="" width=" 45px" height="45px" />
                        </div>
